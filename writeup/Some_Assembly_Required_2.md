```
ozaki@NucBoxM5PLUS:~/project/picoCTF/writeup$ curl http://mercury.picoctf.net:44570/index.html
<html>
<head>
        <meta charset="UTF-8">
...
```
```
ozaki@NucBoxM5PLUS:~/project/picoCTF/writeup$ curl http://mercury.picoctf.net:44570/Y8splx37qY.js
const _0x6d8f = [
  'copy_char',
  'value',
  '207aLjBod',
...
(async () => {
  ...
  let _0x355961 = await WebAssembly.instantiate(
    await _0x1adb5f.arrayBuffer()
  );
  let _0x5c0ffa = _0x355961[_0x835967(0xcc)];
...
function onButtonPress() {
  ...
  let _0x5f4170 = document
    [_0x50ea62(0xd8)](_0x50ea62(0xda))
    [_0x50ea62(0xc5)];
  ...
  exports[_0x50ea62(0xca)]() == 0x1
    ? document.getElementById(_0x50ea62(0xd3)).innerHTML = _0x50ea62(0xce)
    : document.getElementById(_0x50ea62(0xd3)).innerHTML = _0x50ea62(0xd5);
}
